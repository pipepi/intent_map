...
test("workspace and projection scale controls share the external window chrome", async () => {
  const [
    ...
    read("pip-editor/pip-host/view/free-workspace-canvas.tsx"),
    read("pip-editor/pip-host/view/workspace-camera-controls.tsx"),
    read("pip-editor/pip-host/view/workspace-window-chrome.tsx"),
    read("pip-editor/pip-host/view/projection-scale-controls.tsx"),
    read("pip-editor/pip-host/view/workspace-window.tsx"),
    read("pip-editor/pip-host/view/pip-host.module.css"),
    read("pip-editor/pip-host/view/workspace-window.module.css"),
    read("pip-editor/pip-host/view/projection-navbar.tsx"),
    read("pip-editor-io/spot-terminal/elements/window-navigation.js"),
    read("pip-editor/pip-host/view/system-plugin-window.tsx"),
    read("pip-editor/pip-host/view/creator-window.tsx"),
    read("pip-editor/pip-host/view/creator-window.module.css"),
    read("pip-editor/pip-host-io/preferences/panel.tsx"),
  ]);

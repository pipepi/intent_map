...
pub(super) struct RuntimeState {
    pub(super) package: RwLock<Package>,
    pub(super) sources: Vec<CatalogSource>,
    pub(super) user_root: PathBuf,
    pub(super) force_selection: bool,
    pub(super) loader: pip_seed_runtime::Manifest,
    pub(super) profile: Option<RuntimeProfile>,
    pub(super) io_policy: PipIoPolicy,
}

  ...
  create({ graph }) {
    ...
    return {
      patch: { schemaVersion: 1, baseRevision: graph.revision, operations: [
        ...
        { op: "put-node", node: { id: embeddedId, relations: [constant("identity", "relation.core.identity", embeddedId), ref("type", "relation.core.type", "relation.projection.type.instance"), ref("observes", "relation.projection.predicate.observes", terminalId), ref("uses", "relation.projection.predicate.uses", "spot.terminal.projection.embedded"), ref("dives-into", "relation.projection.predicate.dives-into", childrenId)] } },
      ] },

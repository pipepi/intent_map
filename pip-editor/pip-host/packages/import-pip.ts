...
import { decodePip, pipFilename, pipSha256, UNLIMITED_PIP_IO_POLICY, type PipManifest } from "../../pip-package/index.ts";
...
export type PipImportContext = {
  fileName?: string;
  ioOptions?: import("../../pip-package/index.ts").PipIoOptions;
  resolvePackage?(reference: import("../../pip-package/index.ts").PipPackageRef): Uint8Array | undefined | Promise<Uint8Array | undefined>;

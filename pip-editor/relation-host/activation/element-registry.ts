/** Turns installed Element packages into resolvable Web Component declarations. */
import { assertSameImmutablePlugin } from "../packages/package-identity.ts";
import type { ElementDeclaration, ElementPluginPackage, PluginInstallStatus } from "../contracts/package-types.ts";

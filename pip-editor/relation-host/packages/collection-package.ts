/** Converts portable Collection ZIPs into validated graphs and independent workspaces. */
import { assertRelationGraph, relationObjectRefs, type Relation, type RelationGraph, type RelationObject, type RelationRef } from "../../relation/index.ts";
import { decodeElementPackage } from "../packages/element-package.ts";
import { decodeNodeTypePackage } from "../packages/node-type-package.ts";
import { assertNodeCollectionManifest, assertNodeCollectionWorkspace } from "../contracts/package-validation.ts";
import { sha256 } from "./hash.ts";
import type { ElementPluginPackage, NodeCollectionPlugin, NodeTypePluginPackage } from "../contracts/package-types.ts";

...
import { loadRelationDocument } from "../../relation/index.ts";
...
import { assetText, assetsByPath, decodeRelationPip, encodeRelationPip, packageDescriptorDocument, RELATION_PACKAGE_LOADER, textAsset } from "./pip-package.ts";
...
export async function decodeElementPackage(pipBytes: Uint8Array, options?: PipIoOptions): Promise<ElementPluginPackage> {
  ...
  loadRelationDocument(JSON.parse(pip.rootTreeText));

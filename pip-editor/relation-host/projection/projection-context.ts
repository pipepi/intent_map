import type { ObservationScope, ProjectionContext, ProjectionContextInput, ProjectionContextKind, ProjectionSurface, RelationProjection } from "../contracts/package-types.ts";
...
export function normalizeProjectionRegistration(projection: RelationProjection): RelationProjection {
...
export function assertProjectionRegistration(projection: RelationProjection) { normalizeProjectionRegistration(projection); }

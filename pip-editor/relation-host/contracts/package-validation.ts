...
import type { ElementPluginManifest, NodeCollectionManifest, NodeCollectionWorkspace, NodeTypePluginManifest } from "../contracts/package-types.ts";
...
export function assertOntologyGraph(value: unknown): asserts value is import("../../relation/index.ts").RelationGraph {

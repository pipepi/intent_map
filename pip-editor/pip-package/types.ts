...
export type PipManifest =
  ...
  | PipManifestBase & {
      layer: "a3"; elementAbi: "pip-element/2"; entry: "entry.mjs";
  ...
  | PipManifestBase & {
      layer: "a4"; nodeTypeAbi: "pip-node-type/2"; entry: "entry.mjs";
  ...
  | PipManifestBase & {
      // 旧 A5 仅供读取；重新导出时必须使用新的 ABI。
      layer: "a5"; nodeMapAbi: "pip-node-map/1" | "relation-node-map/1"; rootNodeIds: string[];
